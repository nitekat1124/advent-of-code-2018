...
class Solution(SolutionBase):
    ...
    def part2(self, data):
        """
        I'm really suck at optimizing things.

        looking at the changing of the registers, after thousands of times,
        I finally figured out that: these instructions are trying to find
        all the factors of the specific number, and add them all up.
        """
